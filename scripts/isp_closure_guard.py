#!/usr/bin/env python3
"""Canonical-lane closure guard for the invariant subspace problem workspace."""
...
def compute_report(data: dict[str, Any], sigma_star: float | None, strict_coh_zero: bool) -> dict[str, Any]:
    ...
    native_names = ['ISP_G1', 'ISP_G2', 'ISP_G3', 'ISP_G4', 'ISP_G5']
    gates = {name: ('PASS' if passed else 'FAIL') for name, passed in zip(native_names, gate_pass)}
    gates['ISP_G6'] = 'PASS' if coh_pass else 'FAIL'
    gates['ISP_GM'] = 'PASS' if gm_pass else 'FAIL'
    blockers = {}
