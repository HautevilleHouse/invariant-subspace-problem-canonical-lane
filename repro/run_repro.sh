...
mkdir -p .codex_tmp/invariant_subspace_problem
cp artifacts/stitch_constants.json .codex_tmp/invariant_subspace_problem/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/invariant_subspace_problem/constants_registry.json
python3 scripts/isp_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
