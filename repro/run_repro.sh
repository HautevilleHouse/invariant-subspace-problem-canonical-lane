...
mkdir -p .tmp/invariant_subspace_problem
cp artifacts/stitch_constants.json .tmp/invariant_subspace_problem/stitch_constants.json
cp artifacts/constants_registry.json .tmp/invariant_subspace_problem/constants_registry.json
