...
mkdir -p .repro_tmp/invariant_subspace_problem
cp artifacts/stitch_constants.json .repro_tmp/invariant_subspace_problem/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/invariant_subspace_problem/constants_registry.json
